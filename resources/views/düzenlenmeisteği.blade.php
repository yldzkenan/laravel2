            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  <img src="{{ URL::asset ('images/faces/face28.png')}}">
                </div>
...
<br>
              ...
              <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                <div class="p-3 text-center bg-primary"  >
                  <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ URL::asset ('images/faces/face28.png')}}" alt="">
                </div>
                <div class="p-2">
                    @forelse ($numara  as $key => $item)
                  ...
                  <div>
                    <div class="d-flex align-items-center">
                      <div class="sidebar-profile-img">
                        <img src="{{URL::asset('images/faces/face28.png')}}" alt="image">
                      </div>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Düzenleme Sayfası </h2>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                @forelse ($numara  as $key => $item)
                @forelse ($konu  as $key => $itemi)
                <form method="GET" class="my-login-validation" action="{{url('konudüzenleiki/'.$item->numara.'/'.$itemi->id)}}">
