        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Rapor Yeniden Yükleme Ekranı </h2>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <form action={{url('pdfyukleiki/'.$item->numara.'/'.$itemi->id)}} method="post" enctype="multipart/form-data">

                    @csrf
                    @if(session('status'))
                    <h5 style="margin-left: 10px">{{session('status')}}</h5>
                  @endif
              <label>Word Dosyası</label>

               <input type="file" name="fileiki">
