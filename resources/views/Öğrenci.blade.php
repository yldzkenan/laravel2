        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Ana Sayfa </h2>

            </div>
            <div class="row">
              <div class="col-md-12">

                <p>Kocaeli Üniversitesi Proje Takip Sistemine Hoşgeldiniz <br>
                Öğrenci Proje Takip Sisteminde Projeniz ile ilgili gerekli işlemleri yapabilirsiniz</p>
