        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Proje İlerlemeleri </h2>

            </div>
            <div class="row">
              <div class="col-md-12">
                <h4>Konu İlerlemeleri</h4>
