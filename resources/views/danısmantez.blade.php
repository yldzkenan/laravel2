        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Tez Gönderimleri </h2>
              ...
              <div class="col-md-12">
                <table class="styled-table">
                    ...
                    <tbody>
                        ...
                        <td><a href="{{url('onaylaüc/'.$data->id.'/'.$data->danısmannumara)}}" style="color: red">Onayla</a></td>
                        <td><a href="{{url('tezonayla/'.$data->id.'/'.$data->danısmannumara)}}" style="color: red">Reddet</a></td>
                        <td><a href="{{url('danısmanoncekitezler/'.$data->id.'/'.$data->danısmannumara)}}" style="color: red">Önceki Tezler</a></td>
