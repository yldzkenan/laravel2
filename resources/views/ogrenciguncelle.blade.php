        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Bilgi Güncelleme </h2>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card fat">
                    <div class="card-body">
                        @forelse ($numara  as $key => $item)
                        <form method="POST" class="my-login-validation" action="{{url('ogrencigüncelle/'.$item->numara)}}">
                            @csrf
                            @if(session('status'))
                          ...
                          @endif
                            <div class="form-group">
                                <label >Ad</label>
                                <input  class="form-control" name="ad" value="<?php echo $item->ad; ?>" >

                            </div>
                            <div class="form-group">
                                <label >Soyad</label>
                                <input  class="form-control" name="soyad" value="<?php echo $item->soyad; ?>" >
                            ...
                            <div class="form-group">
                                <label >Fakülte</label>
                                <input  class="form-control" name="fakülte" value="<?php echo $item->fakülte; ?>" >

                            </div>
                            <div class="form-group">
                                <label >Bölüm</label>
                                <input  class="form-control" name="bölüm" value="<?php echo $item->bölüm; ?>" >

                            </div>
                            <div class="form-group">
                                <label >Sınıf</label>
                                <input  class="form-control" name="sınıf" value="<?php echo $item->sınıf; ?>" >

                            </div>
                            <div class="form-group">
                                <label >Telefon</label>
                                <input  class="form-control" name="telefon" value="<?php echo $item->telefon; ?>" >
