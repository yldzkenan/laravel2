        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Tez Yeniden Yükleme Ekranı </h2>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <form action={{url('pdfyukledört/'.$item->numara.'/'.$itemi->id)}} method="post" enctype="multipart/form-data">
