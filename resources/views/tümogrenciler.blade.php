          ...
          <ul class="nav">
            ...
            <li class="nav-item sidebar-user-actions">
              <div class="sidebar-user-menu">
                <a class="nav-link" href={{url('cıkısyap')}}><i class="mdi mdi-logout menu-icon"></i>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Öğrenciler </h2>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <table class="styled-table">
                    ...
                    @foreach($numara as  $item)
                    @foreach($datas as $data)
                    <tbody>
                        <tr class="active-row">
                        <td>{{$data->ogrencinumara}}</td>
                        <td><a href="{{url('ogrenciprofildört/'.$item->numara.'/'.$data->ogrencinumara)}}" style="color: red">Öğrenci Profili</a></td>
