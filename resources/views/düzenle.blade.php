        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Düzenleme İsteği </h2>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <form method="POST" class="my-login-validation" action="{{url('düzen/'.$item->numara.'/'.$itemi->id)}}">
                    @csrf
                    @if(session('status'))
                  ...
                  @endif
                    <div class="form-group">
                        ...
                        <input  class="form-control" name="acıklama" value="" >
                    ...
                    <div class="form-group m-0">
                        ...
                        <button type="submit" class="btn btn-primary btn-block" style="background-color:forestgreen ; width:150px;">
                            Onayla
                        </button>
                    </div>
