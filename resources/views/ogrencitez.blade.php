        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              ...
              <h2 class="text-dark font-weight-bold mb-2"> Tez Yükleme Ekranı </h2>
              <a style="color: red" href={{url('oncekitezler/'.$item->numara.'/'.$itemi->id)}}>
                Önceki Tez Yüklemelerim
             </a>
             @empty
              ...
              <div class="col-md-12">
                ...
                <table class="styled-table">
                    ...
                    <tbody>
                        ...
                        <td>{{$data->onay}}</td>
                        <td><a href="{{url('tezyükleme/'.$data->ogrencinumara.'/'.$data->konuid)}}" style="color: red">Tez Yükleme</a></td>
