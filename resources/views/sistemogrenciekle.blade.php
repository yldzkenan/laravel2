        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Öğrenci Ekleme Sayfası </h2>

            </div>
            <div class="row">
              <div class="col-md-12">
                @forelse ($ogrencinumara  as $key => $item)
                @forelse ($numara  as $key => $itemiki)
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{$item->sınıf}}</td>
                            <td>{{$item->telefon}}</td>
                            <td><a style="color: red" href={{url('ogrenciekleiki/'.$item->numara.'/'.$itemiki->numara)}}>
                                Ekle
                            </a></td>
                        </tr>
