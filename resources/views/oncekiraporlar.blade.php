        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Rapor Arşivi </h2>

            </div>
            <div class="row">
              <div class="col-md-12">
<h4>Beklemede Olan Raporlar</h4>
                    ...
                    <table class="styled-table">
                        ...
                        <table class="styled-table">
                            ...
                            <tbody>
                                ...
                                <td>{{$data->onay}}</td>
                                <td>{{$data->acıklama}}</td>
                                <td><a href="{{url('raporeklemeüc/'.$data->ogrencinumara.'/'.$data->konuid)}}" style="color: red">Yeniden Yükle</a></td>
