        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              ...
              <h2 class="text-dark font-weight-bold mb-2"> Rapor Yükleme Ekranı </h2>
              <a style="color: red" href={{url('oncekiraporlar/'.$item->numara.'/'.$itemi->id)}}>
                Önceki Rapor Yüklemelerim
             </a>
             @empty
                ...
                <table class="styled-table">
                    ...
                    <tbody>
                        <tr class="active-row">
                            ...
                            <td><a style="color: red" href={{url('raporeklemeiki/'.$item->numara.'/'.$itemi->id)}}>
                               Rapor Yükle
                            </a></td>
