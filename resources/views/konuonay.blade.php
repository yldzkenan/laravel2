        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Konu Onay Ekranı </h2>

            </div>
            <div class="row">
              <div class="col-md-12">
                <h4 class="text-dark font-weight-bold mb-2">Konular </h2>
                    <table class="styled-table">
                        ...
                        <tbody>
                            <tr class="active-row">
                                ...
                                <td><a style="color: red" href={{url('onayla/'.$item->numara.'/'.$itemi->id)}}>
                                    Onayla
                                </a></td>
                                <td><a style="color: red" href={{url('düzenleiste/'.$item->numara.'/'.$itemi->id)}}>
                                    Düzenleme İste
                                </a></td>
                                <td><a style="color: red" href={{url('rediste/'.$item->numara.'/'.$itemi->id)}}>
                                    Reddet
                                </a></td>
